...
def TGraphFromTree_xsec_rescaled_xaxis(tree, xvar, yvar, selection): ## MY FUNCTION
    tree.Draw(xvar + '/0.9569:' + yvar, selection, 'goff')
    gr = R.TGraph(tree.GetSelectedRows(), tree.GetV1(), tree.GetV2())
    return gr
...
def TGraph2DFromTree_xsec_rescaled_xaxis(tree, xvar,  yvar, zvar, selection):  ## MY FUNCTION
    tree.Draw(xvar + '/0.9569:' + yvar + ':' + zvar, selection, 'goff')
    gr = R.TGraph2D(
        tree.GetSelectedRows(), tree.GetV1(), tree.GetV2(), tree.GetV3())
    return gr
