...
class mvaTrainingNtupleConfig_2lss_1tau(analyzeConfig):
  ...
  def __init__(self, outputDir, executable_analyze, samples, lepton_selections, lepton_charge_selections, hadTau_selection, central_or_shifts,
    ...
    self.cfgFile_analyze_original = os.path.join(self.workingDir, "produceTTHMVATrainingNtuple_2lss_1tau_cfg.py")
    ...
    self.histogramDir_prep_dcard = "ntuple_2lss_1tau_SS_Tight"
  ...
  def createCfg_analyze(self, inputFiles, outputFile, sample_category, era, triggers,
    ...
    """Create python configuration file for the produceTTHMVATrainingNtuple_2lss_1tau executable (analysis code)
    ...
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.process = cms.string('%s')" % sample_category)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.era = cms.string('%s')" % era)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.use_triggers_1e = cms.bool(%s)" % ("1e" in triggers))
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.use_triggers_2e = cms.bool(%s)" % ("2e" in triggers))
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.use_triggers_1mu = cms.bool(%s)" % ("1mu" in triggers))
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.use_triggers_2mu = cms.bool(%s)" % ("2mu" in triggers))
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.use_triggers_1e1mu = cms.bool(%s)" % ("1e1mu" in triggers))
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.leptonSelection = cms.string('%s')" % lepton_selection)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.leptonChargeSelection = cms.string('%s')" % lepton_charge_selection)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.hadTauSelection = cms.string('%s')" % hadTau_selection)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.isMC = cms.bool(%s)" % is_mc)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.central_or_shift = cms.string('%s')" % central_or_shift)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.lumiScale = cms.double(%f)" % lumi_scale)
    lines.append("process.produceTTHMVATrainingNtuple_2lss_1tau.apply_trigger_bits = cms.bool(%s)" % apply_trigger_bits)
