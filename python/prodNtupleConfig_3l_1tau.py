...
class prodNtupleConfig_3l_1tau(prodNtupleConfig):
    """Configuration metadata needed to run Ntuple production for 3l_1tau channel.
    ...
    def __init__(self, configDir, outputDir, executable_prodNtuple, cfgFile_prodNtuple, samples,
        ...
        prodNtupleConfig.__init__(self, configDir, outputDir, executable_prodNtuple, "3l_1tau", samples,
          era, debug, running_method, rle_directory, version, num_parallel_jobs)
