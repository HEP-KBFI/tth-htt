...
class analyzeConfig_1l_1tau(analyzeConfig):
  ...
  def __init__(self,
    ...
    self.make_plots_backgrounds_SS = [ "TT", "TTW", "TTZ", "TTWW", "EWK", "Rares", "tHq", "tHW" ] + [ "conversions", "fakes_data", "flips_mc" ]
      ...
      for lepton_and_hadTau_selection in self.lepton_and_hadTau_selections:
        ...
        for lepton_and_hadTau_frWeight in self.lepton_and_hadTau_frWeights:
            ...
            if is_mc:
              ...
              for sample_category in sample_categories:
                ...
                for genMatch_category in genMatch_categories:
                  ...
                  key_addBackgrounds_dir = getKey(process_name, lepton_and_hadTau_selection_and_frWeight, chargeSumSelection)
                  ...
                  if genMatch_category == "nonfake":
                    ...
                    addBackgrounds_job_tuple = (process_name, "%s_flips" % sample_category, lepton_and_hadTau_selection_and_frWeight, chargeSumSelection)
          ...
          self.jobOptions_addBackgrounds_sum[key_addBackgrounds_job_flips] = {
            'inputFile' : self.outputFile_hadd_stage1_5[key_hadd_stage1_5_job],
            'cfgFile_modified' : os.path.join(self.dirs[DKEY_CFGS], "addBackgrounds_%s_%s_%s_cfg.py" % addBackgrounds_job_flips_tuple),
            'outputFile' : os.path.join(self.dirs[DKEY_HIST], "addBackgrounds_%s_%s_%s.root" % addBackgrounds_job_flips_tuple),
            'logFile' : os.path.join(self.dirs[DKEY_LOGS], "addBackgrounds_%s_flips_%s_%s.log" % addBackgrounds_job_flips_tuple),
            'categories' : [ getHistogramDir(category, lepton_and_hadTau_selection, lepton_and_hadTau_frWeight, chargeSumSelection) for category in self.categories ],
            'processes_input' : processes_input,
          ...
          self.jobOptions_addBackgrounds_sum[key_addBackgrounds_job_conversions] = {
            'inputFile' : self.outputFile_hadd_stage1_5[key_hadd_stage1_5_job],
            'cfgFile_modified' : os.path.join(self.dirs[DKEY_CFGS], "addBackgrounds_%s_%s_%s_cfg.py" % addBackgrounds_job_conversions_tuple),
            'outputFile' : os.path.join(self.dirs[DKEY_HIST], "addBackgrounds_%s_%s_%s.root" % addBackgrounds_job_conversions_tuple),
            'logFile' : os.path.join(self.dirs[DKEY_LOGS], "addBackgrounds_%s_%s_%s.log" % addBackgrounds_job_conversions_tuple),
            'categories' : [ getHistogramDir(category, lepton_and_hadTau_selection, lepton_and_hadTau_frWeight, chargeSumSelection) for category in self.categories ],
            'processes_input' : processes_input,
    ...
    for chargeSumSelection in self.chargeSumSelections:
      ...
      for category_signal in self.categories:
        ...
        self.jobOptions_addFlips[key_addFlips_job] = {
          ...
          'cfgFile_modified' : os.path.join(self.dirs[DKEY_CFGS], "addBackgroundLeptonFlips_%s_%s_cfg.py" % addFlips_job_tuple),
          'outputFile' : os.path.join(self.dirs[DKEY_HIST], "addBackgroundLeptonFlips_%s_%s.root" % addFlips_job_tuple),
          'logFile' : os.path.join(self.dirs[DKEY_LOGS], "addBackgroundLeptonFlips_%s_%s.log" % addFlips_job_tuple),
      ...
      for chargeSumSelection in self.chargeSumSelections:
        for histogramToFit in self.histograms_to_fit:
          ...
          self.jobOptions_prep_dcard[key_prep_dcard_job] = {
            ...
            'cfgFile_modified' : os.path.join(self.dirs[DKEY_CFGS], "prepareDatacards_%s_%s_%s_%s_cfg.py" % prep_dcard_job_tuple),
            'datacardFile' : os.path.join(self.dirs[DKEY_DCRD], "prepareDatacards_%s_%s_%s_%s.root" % prep_dcard_job_tuple),
