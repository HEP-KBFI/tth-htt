...
# 2018: https://twiki.cern.ch/twiki/bin/view/CMS/MissingETOptionalFiltersRun2?rev=117#Early_2018_data
# 2017: https://twiki.cern.ch/twiki/bin/view/CMS/MissingETOptionalFiltersRun2?rev=117#Moriond_2018
# 2016: https://twiki.cern.ch/twiki/bin/view/CMS/MissingETOptionalFiltersRun2?rev=117#Moriond_2017
...
recommendedMEtFilters_2018 = cms.PSet(
    ...
    apply_Flag_ecalLaserCorrFilter                = cms.PSet(forMC = cms.bool(False), forData = cms.bool(False)),
    apply_Flag_eeBadScFilter                      = cms.PSet(forMC = cms.bool(False), forData = cms.bool(True)),
    apply_Flag_globalSuperTightHalo2016Filter     = cms.PSet(forMC = cms.bool(True),  forData = cms.bool(True)), # NB! not suggested for FastSim samples
