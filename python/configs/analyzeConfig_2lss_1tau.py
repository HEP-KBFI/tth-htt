...
class analyzeConfig_2lss_1tau(analyzeConfig):
  ...
  def __init__(self,
    ...
    self.nonfake_backgrounds = [ "TT", "TTW", "TTWW", "TTZ", "EWK", "WZ", "ZZ", "Rares", "tHq", "tHW", "VH", "WH", "ZH", "HH", "ggH", "qqH", "TTWH", "TTZH" ]
  ...
  def accept_systematics(self, central_or_shift, is_mc, lepton_and_hadTau_selection, lepton_charge_selection, sample_category, sample_name):
              ...
              for central_or_shift_or_dummy in central_or_shifts_extended:
                ...
                for process_name_or_dummy in process_name_extended:
                  ...
                  if central_or_shift_or_dummy not in central_or_shift_extensions and not self.accept_systematics(
                        central_or_shift_or_dummy, is_mc, lepton_and_hadTau_selection, lepton_charge_selection, sample_category, sample_name
                      ):
                    continue
