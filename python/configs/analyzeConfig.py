...
class analyzeConfig(object):
    ...
    def __init__(self,
        ...
        if self.btagSFRatio_useCentralOnly:
          ...
          self.btagSFRatioFile = "/hdfs/local/karl/btagSFratios_final/2022Jan04/btagSF_{era}_fullSys.root".format(
            era = self.era,
          )
    ...
    def createCfg_prep_dcard(self, jobOptions):
        ...
        if len(self.central_or_shifts) > 1 and self.ttbar_syst_enabled:
          ...
          central_or_shifts_added = [ "colorUp", 'colorDown', 'hdampmodUp', 'hdampmodDown', 'uemodUp', 'uemodDown', 'mtopmodUp', 'mtopmodDown', 'GluonMoveUp', 'GluonMoveDown', 'QCDbasedUp', 'QCDbasedDown', 'erdONUp', 'erdONDown']
