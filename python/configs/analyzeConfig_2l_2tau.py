                  ...
                  for sample_category in sample_categories:
                    ...
                    for genMatch_category in genMatch_categories:
                      ...
                      if genMatch_category == "Convs":
                        ...
                        addBackgrounds_job_tuple = (process_name, "%s_Convs" % sample_category, lepton_charge_selection, hadTau_charge_selection,
                          lepton_and_hadTau_selection_and_frWeight, chargeSumSelection)
                        ...
                        if sample_category in self.signalProcs:
                          ...
                          if sample_category in self.ttHProcs : lepton_and_hadTau_genMatches.extend(self.lepton_and_hadTau_genMatches_fakes)
                          processes_input = []
                          ## X: save also the process without the decay modes: do we need?
                          if sample_category not in self.ttHProcs :
                        ...
                        if sample_category in self.signalProcs:
                          ...
                          if sample_category in self.ttHProcs : lepton_and_hadTau_genMatches.extend(self.lepton_and_hadTau_genMatches_gentau)
                          processes_input = []
                          ## X: save also the process without the decay modes: do we need?
                          if sample_category not in self.ttHProcs :
                        ...
                        if sample_category in self.signalProcs:
                          ...
                          if sample_category in self.ttHProcs : lepton_and_hadTau_genMatches.extend(self.lepton_and_hadTau_genMatches_faketau)
                          processes_input = []
                          ## X: save also the process without the decay modes: do we need?
                          if sample_category not in self.ttHProcs :
