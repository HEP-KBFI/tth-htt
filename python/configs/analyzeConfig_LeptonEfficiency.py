...
fit_param_range_map = {
  'electron' : {
    'HHorTTH':{
      'tight' : {
        'incl'                            : '-4.0,20.0', 
        'absEtaLt0_9_Pt10_0to15_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt15_0to20_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt20_0to25_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt25_0to30_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt30_0to35_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt35_0to40_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt40_0to45_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt45_0to60_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt60_0to80_0'        : '-4.0,20.0', 
        'absEtaLt0_9_Pt80_0to120_0'       : '-4.0,20.0', 
        'absEta0_9to1_2_Pt10_0to15_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt15_0to20_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt20_0to25_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt25_0to30_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt30_0to35_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt35_0to40_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt40_0to45_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt45_0to60_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt60_0to80_0'     : '-4.0,20.0', 
        'absEta0_9to1_2_Pt80_0to120_0'    : '-4.0,20.0', 
        'absEta1_2to2_1_Pt10_0to15_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt15_0to20_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt20_0to25_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt25_0to30_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt30_0to35_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt35_0to40_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt40_0to45_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt45_0to60_0'     : '-4.0,20.0',  
        'absEta1_2to2_1_Pt60_0to80_0'     : '-4.0,20.0', 
        'absEta1_2to2_1_Pt80_0to120_0'    : '-4.0,20.0', 
        'absEta2_1to2_5_Pt10_0to15_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt15_0to20_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt20_0to25_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt25_0to30_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt30_0to35_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt35_0to40_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt40_0to45_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt45_0to60_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt60_0to80_0'     : '-4.0,20.0', 
        'absEta2_1to2_5_Pt80_0to120_0'    : '-4.0,20.0', 
      },
      'presel_not_tight' : {
        'incl'                            : '-4.0,20.0', 
        'absEtaLt0_9_Pt10_0to15_0'        : '-4.0,20.0', 
...
def construct_lepton_params(lepton, lepton_short, LFR_type, selection, absEtaPtBinString, error_msg):
  ...
  TagAndProbe_id = '%s_TagAndProbe_%s' % (lepton_short, absEtaPtBinString)
  return (lepton_id_short, lepton_range, lepton_id, TagAndProbe_id)
...
class analyzeConfig_LeptonEfficiency(analyzeConfig):
  ...
  def __init__(self,
    ...
    self.histogram_to_fit = numerator_histogram[0]
    ...
    if self.prep_dcard:
      ...
      for lepton in ['electron', 'muon']:
        ...
        for selection in ['presel_not_tight', 'tight']:
          ...
          if not is_num : ## Run on tight selection only (since presel_not_tight would be done on the fly now)
            continue
          for params in lepton_bins[lepton][selection]:
            l_array, l_range, l_sub_dir, l_TagAndProbe, l_eta_low, l_eta_high, l_pt_low, l_pt_high, l_is_inclusive = params
            ...
            postfit_script_path = os.path.join(
              ...
              'mlfit_%s_%s.sh' % (self.numerator_histogram if is_num else self.denominator_histogram, l_TagAndProbe)
            )
      ...
      makefile_templatized = jinja2.Template(makefile_template).render(
        new_cmssw_base = self.cmssw_base_dir_combine,
        setup_dcards_script = setup_dcards_script_path,
        histogram_to_fit = self.histogram_to_fit,
