...
recommendedMEtFilters = cms.PSet(
    ...
    apply_Flag_eeBadScFilter                      = cms.bool(False), # will be set to true for data only as per gitlab page ( https://gitlab.cern.ch/ttH_leptons/doc/blob/master/2017/event_selection.md#4-event-selection ) suggestions later  
