...
class analyzeConfig_2lss_1tau(analyzeConfig):
  ...
  """
  def __init__(self, outputDir, executable_analyze, cfgFile_analyze, samples, changeBranchNames, lepton_charge_selections, hadTau_selection, applyFakeRateWeights, central_or_shifts,
