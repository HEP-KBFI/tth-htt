...
class analyzeConfig_2l_2tau(analyzeConfig):
  ...
  """
  def __init__(self, outputDir, executable_analyze, lepton_charge_selections, hadTau_selections, hadTau_charge_selections, central_or_shifts,
    ...
    analyzeConfig.__init__(self, outputDir, executable_analyze, "2l_2tau", central_or_shifts,
      max_files_per_job, use_lumi, lumi, debug, running_method, num_parallel_jobs, 
      histograms_to_fit)

    self.samples = tthAnalyzeSamples_2l_2tau.samples
  ...
  def createCfg_analyze(self, inputFiles, outputFile, sample_category, triggers, lepton_charge_selection, hadTau_selection, hadTau_genMatch, hadTau_frWeight, hadTau_charge_selection,
	            ...
	            if central_or_shift != "central" and not (hadTau_selection == "Tight" and hadTau_charge_selection == "OS"):
	              ...
	              continue
                    ...
                    self.createCfg_analyze(inputFiles, self.histogramFiles[key_file], sample_category, triggers,
                      lepton_charge_selection, hadTau_selection, hadTau_genMatch, hadTau_frWeight, hadTau_charge_selection,
