...
# ./scripts/create_dictionary.py -v -m python/samples/metaDict_2017_leptonFR_test2.py -p /hdfs/local/karl/ttHNtupleProduction/2017/2018Feb21_wNanoPrep_woPresel_all/ntuples -Z zeroes.txt -z zombies.txt -N samples_2017 -E 2017
