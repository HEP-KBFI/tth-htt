...
# file generated at 2019-12-06 12:29:27 with the following command:
# create_dictionary.py -m python/samples/metaDict_2018_sync.py -p /hdfs/local/karl/addMEM/2018/2019Dec05_sync_nonNom/final_ntuples/3l -N samples_2018 -E 2018 -o python/samples -g tthAnalyzeSamples_2018_addMEM_3l_deepVSjVLoose_sync.py -M
...
samples_2018["/ttHToNonbb_M125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM"] = OD([
  ...
  ("fsize_local",                     73523535), # 73.52MB, avg file size 73.52MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/addMEM/2018/2019Dec05_sync_nonNom/final_ntuples/3l/ttHToNonbb_M125_powheg"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
