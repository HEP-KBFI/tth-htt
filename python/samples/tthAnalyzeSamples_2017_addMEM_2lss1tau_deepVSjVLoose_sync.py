...
# file generated at 2019-10-19 12:40:54 with the following command:
# create_dictionary.py -m python/samples/metaDict_2017_sync.py -p /hdfs/local/karl/addMEM/2017/2019Oct19_sync_nonNom_full/final_ntuples/2lss_1tau -N samples_2017 -E 2017 -o python/samples -g tthAnalyzeSamples_2017_addMEM_2lss1tau_deepVSjVLoose_sync.py -M
...
samples_2017["/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM"] = OD([
  ...
  ("fsize_local",                     164331829), # 164.33MB, avg file size 164.33MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/addMEM/2017/2019Oct19_sync_nonNom_full/final_ntuples/2lss_1tau/ttHJetToNonbb_M125_amcatnlo"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
