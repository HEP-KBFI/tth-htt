...
# create_dictionary.py -m python/samples/metaDict_2018_sync.py -p /local/karl/sync_ntuples/2018/nanoAODproduction/2020Oct26 -N samples_2018 -E 2018 -o python/samples -g tthAnalyzeSamples_2018_nanoAOD_sync.py -M
...
samples_2018["/ttHToNonbb_M125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM"] = OD([
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/local/karl/sync_ntuples/2018/nanoAODproduction/2020Oct26/ttHToNonbb_M125_powheg"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
