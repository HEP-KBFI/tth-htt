...
# /home/karl/CMSSW_9_4_0/bin/slc6_amd64_gcc630/create_dictionary.py -v -m python/samples/metaDict_2017_test.py -p /hdfs/local/karl/nanoAOD_postprocessed -Z zeroes.txt -z zombies.txt -N samples_2017 -E 2017
...
samples_2017["/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/RunIISummer17MiniAOD-92X_upgrade2017_realistic_v10_ext1-v1/MINIAODSIM"] = OD([
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/nanoAOD_postprocessed/92X_upgrade2017_realistic_v10_ext1-v1/TT"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
