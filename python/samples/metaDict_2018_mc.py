...
# file generated at 2019-03-13 22:10:27 with the following command:
...
meta_dictionary["/TTJets_SingleLeptFromT_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         58018677),
  ("nof_db_files",          1523),
  ("fsize_db",              3196347618226),
  ("xsection",              182.67),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 3.20TB; nevents: 58.02M; release: 10_2_5; last modified: 2018-12-16 09:18:47"),
])
...
meta_dictionary["/TGJets_TuneCP5_13TeV_amcatnlo_madspin_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM"] =  OD([
  ("crab_string",           ""),
  ("sample_category",       "Rares"),
  ("process_name_specific", "TGJets"),
  ("nof_db_events",         1930000),
  ("nof_db_files",          60),
  ("fsize_db",              96939577799),
  ("xsection",              2.967),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: VALID; size: 96.94GB; nevents: 1.93M; release: 10_2_5; last modified: 2019-02-01 23:48:11"),
])
...
meta_dictionary["/DYBBJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         3926288),
  ("nof_db_files",          99),
  ("fsize_db",              194958692477),
  ("xsection",              14.59),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 194.96GB; nevents: 3.93M; release: 10_2_5; last modified: 2019-02-12 05:02:22"),
])
...
meta_dictionary["/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         66443486),
  ("nof_db_files",          935),
  ("fsize_db",              2526697721612),
  ("xsection",              61526.7),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 2.53TB; nevents: 66.44M; release: 10_2_5; last modified: 2018-11-29 05:32:55"),
])
...
meta_dictionary["/WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         29521158),
  ("nof_db_files",          562),
  ("fsize_db",              1316589379677),
  ("xsection",              1625.94),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: VALID; size: 1.32TB; nevents: 29.52M; release: 10_2_5; last modified: 2019-02-13 04:48:10"),
])
...
meta_dictionary["/WWTo1L1Nu2Q_13TeV_amcatnloFXFX_madspin_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         2390406),
  ("nof_db_files",          56),
  ("fsize_db",              103513409191),
  ("xsection",              49.997),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 103.51GB; nevents: 2.39M; release: 10_2_5; last modified: 2019-02-13 04:22:37"),
])
...
meta_dictionary["/ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         47544000),
  ("nof_db_files",          824),
  ("fsize_db",              2052765309282),
  ("xsection",              0.564),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 2.05TB; nevents: 47.54M; release: 10_2_5; last modified: 2018-12-11 01:56:30"),
])
