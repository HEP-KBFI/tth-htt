...
# file generated at 2019-07-04 18:50:41 with the following command:
# find_samples.py -V -m python/samples/metaDict_2018_data.py -d ../NanoAOD/test/datasets/txt/datasets_data_2018_17Sep18.txt -p SingleMuon EGamma DoubleMuon MuonEG Tau -g ../NanoAOD/data/Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt -v 10_2_4_patch1 -r 2018 -C +17Sep2018 +Run2018D-PromptReco -l
...
meta_dictionary["/SingleMuon/Run2018A-17Sep2018-v2/MINIAOD"] =  OD([
  ...
  ("comment",               "status: VALID; size: 8.14TB; nevents: 241.61M; release: 10_2_4_patch1; last modified: 2018-10-25 11:05:39"),
])
...
meta_dictionary["/SingleMuon/Run2018B-17Sep2018-v1/MINIAOD"] =  OD([
  ...
  ("comment",               "status: VALID; size: 3.90TB; nevents: 119.92M; release: 10_2_4_patch1; last modified: 2018-10-15 08:23:13"),
])
...
meta_dictionary["/DoubleMuon/Run2018A-17Sep2018-v2/MINIAOD"] =  OD([
  ...
  ("run_range",             [315257, 316995]),
  ("golden_run_range",      [315257, 316995]),
  ("comment",               "status: VALID; size: 3.05TB; nevents: 75.50M; release: 10_2_4_patch1; last modified: 2018-11-02 00:30:12"),
])
...
meta_dictionary["/DoubleMuon/Run2018B-17Sep2018-v1/MINIAOD"] =  OD([
  ...
  ("run_range",             [317080, 319310]),
  ("golden_run_range",      [317080, 319077]),
  ("comment",               "status: VALID; size: 1.38TB; nevents: 35.06M; release: 10_2_4_patch1; last modified: 2018-10-11 09:00:06"),
])
...
meta_dictionary["/MuonEG/Run2018A-17Sep2018-v1/MINIAOD"] =  OD([
  ...
  ("run_range",             [315257, 316995]),
  ("golden_run_range",      [315257, 316995]),
  ("comment",               "status: VALID; size: 1.49TB; nevents: 32.96M; release: 10_2_4_patch1; last modified: 2018-12-21 01:20:07"),
])
...
meta_dictionary["/MuonEG/Run2018B-17Sep2018-v1/MINIAOD"] =  OD([
  ...
  ("run_range",             [317080, 319310]),
  ("golden_run_range",      [317080, 319077]),
  ("comment",               "status: VALID; size: 715.53GB; nevents: 16.21M; release: 10_2_4_patch1; last modified: 2019-01-31 14:17:15"),
])
...
meta_dictionary["/Tau/Run2018A-17Sep2018-v1/MINIAOD"] =  OD([
  ...
  ("run_range",             [315257, 316995]),
  ("golden_run_range",      [315257, 316995]),
  ("comment",               "status: VALID; size: 2.57TB; nevents: 63.15M; release: 10_2_4_patch1; last modified: 2018-11-25 08:28:53"),
])
...
meta_dictionary["/Tau/Run2018B-17Sep2018-v1/MINIAOD"] =  OD([
  ...
  ("run_range",             [317080, 319310]),
  ("golden_run_range",      [317080, 319077]),
  ("comment",               "status: VALID; size: 1.29TB; nevents: 32.68M; release: 10_2_4_patch1; last modified: 2018-11-07 09:58:00"),
])
