...
# file generated at 2019-12-15 14:02:47 with the following command:
# create_dictionary.py -m python/samples/metaDict_2017_sync.py -p /hdfs/local/karl/addMEM/2017/2019Dec15_sync_nonNom/final_ntuples/3l -N samples_2017 -E 2017 -o python/samples -g tthAnalyzeSamples_2017_addMEM_3l_deepVSjVLoose_sync.py -M
...
samples_2017["/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM"] = OD([
  ...
  ("fsize_local",                     82394150), # 82.39MB, avg file size 82.39MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/addMEM/2017/2019Dec15_sync_nonNom/final_ntuples/3l/ttHJetToNonbb_M125_amcatnlo"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
