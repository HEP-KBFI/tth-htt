...
from tthAnalysis.HiggsToTauTau.samples.metaDict_2017_vh import meta_dictionary as meta_dictionary_vh
...
meta_dictionary = collections.OrderedDict(itertools.chain(
  meta_dictionary_data.items(), meta_dictionary_mc.items(), meta_dictionary_private.items(), meta_dictionary_vh.items()
))
