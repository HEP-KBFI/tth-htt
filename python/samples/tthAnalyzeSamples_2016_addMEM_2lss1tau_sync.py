...
# file generated at 2019-09-28 12:13:59 with the following command:
# create_dictionary.py -m python/samples/metaDict_2016_sync.py -p /hdfs/local/karl/addMEM/2016/2019Sep26v2_sync_nonNom_full/final_ntuples/2lss_1tau -N samples_2016 -E 2016 -o python/samples -g tthAnalyzeSamples_2016_addMEM_2lss1tau_sync.py -M
...
samples_2016["/ttHToNonbb_M125_TuneCUETP8M2_ttHtranche3_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3-v2/MINIAODSIM"] = OD([
  ...
  ("nof_tree_events",                 15075),
  ("nof_db_events",                   3981250),
  ("fsize_local",                     159450743), # 159.45MB, avg file size 159.45MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/addMEM/2016/2019Sep26v2_sync_nonNom_full/final_ntuples/2lss_1tau/ttHToNonbb_M125_powheg"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
