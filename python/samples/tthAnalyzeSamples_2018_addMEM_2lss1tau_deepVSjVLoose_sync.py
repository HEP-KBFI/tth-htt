...
# file generated at 2019-11-26 21:34:56 with the following command:
# create_dictionary.py -m python/samples/metaDict_2018_sync.py -p /hdfs/local/karl/addMEM/2018/2019Nov26_sync_nonNom_full/final_ntuples/2lss_1tau -N samples_2018 -E 2018 -o python/samples -g tthAnalyzeSamples_2018_addMEM_2lss1tau_deepVSjVLoose_sync.py -M
...
samples_2018["/ttHToNonbb_M125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM"] = OD([
  ...
  ("fsize_local",                     142319312), # 142.32MB, avg file size 142.32MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/addMEM/2018/2019Nov26_sync_nonNom_full/final_ntuples/2lss_1tau/ttHToNonbb_M125_powheg"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
