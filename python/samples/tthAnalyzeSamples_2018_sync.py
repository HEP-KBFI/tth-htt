...
# file generated at 2019-05-20 03:46:38 with the following command:
# create_dictionary.py -m python/samples/metaDict_2018_sync.py -p /home/karl/ttHNtupleProduction/2018/2019May20_woPresel_nonNom_sync/ntuples -N samples_2018 -E 2018 -o python/samples -g tthAnalyzeSamples_2018_sync.py -M
...
samples_2018["/ttHToNonbb_M125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM"] = OD([
  ...
  ("fsize_local",                     258029456), # 258.03MB, avg file size 258.03MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/home/karl/ttHNtupleProduction/2018/2019May20_woPresel_nonNom_sync/ntuples/ttHToNonbb_M125_powheg"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
