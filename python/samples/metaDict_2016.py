...
from tthAnalysis.HiggsToTauTau.samples.metaDict_2016_fastsim import meta_dictionary as meta_dictionary_fastsim
...
meta_dictionary = collections.OrderedDict(itertools.chain(
  meta_dictionary_data.items(), meta_dictionary_mc.items(), meta_dictionary_fastsim.items()
))
