#include "tthAnalysis/HiggsToTauTau/interface/CutFlowTableHistManager_2los_1tau.h"
...
CutFlowTableHistManager_2los_1tau::CutFlowTableHistManager_2los_1tau(const edm::ParameterSet& cfg)
  : HistManagerBase(cfg)
{}

void CutFlowTableHistManager_2los_1tau::bookHistograms(TFileDirectory& dir)
{
  int numCuts = 21;
  ...
  xAxis->SetBinLabel(17, "sel lepton-pair OS charge");
  xAxis->SetBinLabel(19, "Z-boson mass veto");
  xAxis->SetBinLabel(20, "met LD > 0.2");
  xAxis->SetBinLabel(21, "signal region veto");
}

void CutFlowTableHistManager_2los_1tau::fillHistograms(const std::string& cut, double evtWeight)
{
