...
#include "tthAnalysis/HiggsToTauTau/interface/analysisAuxFunctions.h" // Era::, get_era(), isHigherPt()
#include "tthAnalysis/HiggsToTauTau/interface/LocalFileInPath.h" // LocalFileInPath
#include "tthAnalysis/HiggsToTauTau/interface/lutAuxFunctions.h" // lutWrapperTH2
#include "tthAnalysis/HiggsToTauTau/interface/RecoJetAK8.h" // RecoJetAK8, RecoSubjetAK8
#include "tthAnalysis/HiggsToTauTau/interface/sysUncertOptions.h" // SubjetBtagSys::
#include "tthAnalysis/HiggsToTauTau/interface/data_to_MC_corrections_auxFunctions.h" // aux::compSF()
...
std::map<int, BTagEntry::JetFlavor> SubjetBtagSF::flavorMap_ = {
  { 0, BTagEntry::JetFlavor::FLAV_UDSG },
  { 4, BTagEntry::JetFlavor::FLAV_C    },
  { 5, BTagEntry::JetFlavor::FLAV_B    },
};

SubjetBtagSF::SubjetBtagSF(Era era,
...
SubjetBtagSF * const
SubjetBtagSF::addGenParticles(const std::vector<GenParticle> & genParticles)
{
...
SubjetBtagSF * const
SubjetBtagSF::addSubjets(const RecoJetAK8 * const fatJet)
{
  if(fatJet)
  {
...
SubjetBtagSF::get_flavors()
{
  ...
  std::sort(subjets_.begin(), subjets_.end(), isHigherPt);
...
double
SubjetBtagSF::get_sf(SubjetBtagSys option)
{
