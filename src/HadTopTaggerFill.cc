...
{
	//std::cout << "HadTopTaggerFill::operator(): Case 3: " << std::endl;
	mvaInputs_.clear();
...
double
HadTopTaggerFill::operator()(const RecoSubjetHTTv2 & recBJet,
                             const RecoSubjetHTTv2 & recWJet1,
                             const RecoSubjetHTTv2 & recWJet2)
{
	//std::cout << "HadTopTaggerFill::operator(): Case 1: " << std::endl;
	mvaInputs_.clear();
  const Particle::LorentzVector p4_bWj1Wj2 = recBJet.p4() + recWJet1.p4() + recWJet2.p4();
  const Particle::LorentzVector p4_Wj1Wj2  = recWJet1.p4() + recWJet2.p4();
...
//---
  ...
  mvaInputs_["logPKinFit"]         = kinFit_->p()    > 0. ? std::log(kinFit_->p())    : -1.e+3;
  mvaInputs_["logPErrKinFit"]      = kinFit_->pErr() > 0. ? std::log(kinFit_->pErr()) : -1.e+3;
  //mvaInputs_["qg_b"]               = -1; // recBJet.QGDiscr(); // ERROR: No member function
  //mvaInputs_["qg_Wj1"]             = -1; // recWJet1.QGDiscr(); // ERROR: No member function
  //mvaInputs_["qg_Wj2"]             = -1; // recWJet2.QGDiscr(); // ERROR: No member function
  mvaInputs_["pT_bWj1Wj2"]         = p4_bWj1Wj2.pt();
  mvaInputs_["pT_Wj1Wj2"]          = p4_Wj1Wj2.pt();
  mvaInputs_["max_dR_div_expRjet"] = 1.0;
#if 0
...
{
	//std::cout << "HadTopTaggerFill::operator(): Case 2: " << std::endl;
	mvaInputs_.clear();
  const Particle::LorentzVector p4_bWj1Wj2 = recBJet.p4() + recWJet1.p4() + recWJet2.p4();
  const Particle::LorentzVector p4_Wj1Wj2  = recWJet1.p4() + recWJet2.p4();
  ...
  mvaInputs_["m_bWj2"]                 = (recBJet.p4() + recWJet2.p4()).mass();
  mvaInputs_["m_Wj1Wj2_div_m_bWj1Wj2"] = p4_bWj1Wj2.mass() > 0. ? p4_Wj1Wj2.mass() / p4_bWj1Wj2.mass() : -1.;
  mvaInputs_["CSV_b"]                  = recBJet.BtagCSV(); // ERROR: No member function
  mvaInputs_["CSV_Wj1"]                = -1; //recWJet1.BtagCSV(); // ERROR: No member function
  mvaInputs_["CSV_Wj2"]                = -1; //recWJet2.BtagCSV(); // ERROR: No member function
  mvaInputs_["pT_b"]                   = recBJet.pt();
  mvaInputs_["eta_b"]                  = recBJet.eta();
  mvaInputs_["phi_b"]                  = recBJet.phi();
  mvaInputs_["mass_b"]                 = recBJet.mass();
