...
#include "tthAnalysis/HiggsToTauTau/interface/BranchAddressInitializer.h" // BranchAddressInitializer
#include "tthAnalysis/HiggsToTauTau/interface/sysUncertOptions.h" // LHEVptSys::
