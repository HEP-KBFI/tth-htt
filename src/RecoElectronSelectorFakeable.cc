#include "tthAnalysis/HiggsToTauTau/interface/RecoElectronSelectorFakeable.h" // RecoElectronSelectorFakeable

#include <cmath> // fabs

RecoElectronSelectorFakeable::RecoElectronSelectorFakeable(bool debug)
  : min_pt_(10.)
  , max_absEta_(2.5)
  , max_dxy_(0.05)
  , max_dz_(0.1)
