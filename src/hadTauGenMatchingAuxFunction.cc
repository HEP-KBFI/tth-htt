...
std::vector<hadTauGenMatchEntry> getHadTauGenMatch_definitions_1tau()
{
  ...
  hadTauGenMatch_definitions.push_back(hadTauGenMatchEntry("all", kGen_All1, -1, -1, -1, -1));
...
{
  std::vector<hadTauGenMatchEntry> hadTauGenMatch_definitions;
  hadTauGenMatch_definitions.push_back(hadTauGenMatchEntry("all", kGen_All2, -1, -1, -1, -1));
...
{
  std::vector<hadTauGenMatchEntry> hadTauGenMatch_definitions;
  hadTauGenMatch_definitions.push_back(hadTauGenMatchEntry("all", kGen_All3, -1, -1, -1, -1));
...
namespace
{
					       ...
					       int numGenMatchedHadTaus, int numGenMatchedElectrons, int numGenMatchedMuons, int numGenMatchedJets)
  {
    ...
    for ( std::vector<hadTauGenMatchEntry>::const_iterator hadTauGenMatch_definition = hadTauGenMatch_definitions.begin();
  	  hadTauGenMatch_definition != hadTauGenMatch_definitions.end(); ++hadTauGenMatch_definition ) {
      if ( hadTauGenMatch_definition->numGenMatchedHadTaus_   == numGenMatchedHadTaus   &&
  	   hadTauGenMatch_definition->numGenMatchedElectrons_ == numGenMatchedElectrons &&
	   hadTauGenMatch_definition->numGenMatchedMuons_     == numGenMatchedMuons     &&
	   hadTauGenMatch_definition->numGenMatchedJets_      == numGenMatchedJets      ) hadTauGenMatch = &(*hadTauGenMatch_definition);
    }
