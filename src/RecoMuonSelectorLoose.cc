#include "tthAnalysis/HiggsToTauTau/interface/RecoMuonSelectorLoose.h" // RecoMuonSelectorLoose

#include <cmath> // fabs

RecoMuonSelectorLoose::RecoMuonSelectorLoose(int index, bool debug)
  : min_pt_(5.)
  , max_absEta_(2.4)
  , max_dxy_(0.05)
  , max_dz_(0.1)
