...
void EvtHistManager_0l_2tau::bookHistograms(TFileDirectory& dir)
{
...
void EvtHistManager_0l_2tau::fillHistograms(int numElectrons, int numMuons, int numHadTaus, int numJets, int numBJets_loose, int numBJets_medium,
