  ...
  : HistManagerBase(cfg)
{
  ...
  binningOptions_["sum_Lep_charge"]             = new binningOptionType("sum_Lep_charge",              5, -2.5,  +2.5);
  ...
  binningOptions_["leadFwdJet_eta"]             = new binningOptionType("leadFwdJet_eta",            100, -5.,    5.);
  ...
  binningOptions_["eta_LepLep_los"]             = new binningOptionType("eta_LepLep_los",             50, 0.,  +2.5);
  ...
  binningOptions_["jet3_pt"]                    = new binningOptionType("jet3_pt",                    40,  0.,  400.);
  binningOptions_["jet1_eta"]                   = new binningOptionType("jet1_eta",                   40, -5.,   +5.);
  binningOptions_["jet2_eta"]                   = new binningOptionType("jet2_eta",                   40, -5.,   +5.);
  binningOptions_["jet3_eta"]                   = new binningOptionType("jet3_eta",                   40, -5.,   +5.);
  ...
  binningOptions_["met_LD"]                     = new binningOptionType("met_LD",                     40,  0.,  200.);
  ...
  binningOptions_["massL3"]                     = new binningOptionType("massL3",                     40,  0.,  200.);
  ...
  binningOptions_["nJetForward"]                = new binningOptionType("nJetForward",                10, -0.5,  +9.5);
  binningOptions_["nElectron"]                  = new binningOptionType("nElectron",                  10, -0.5,  +9.5);
  ...
  binningOptions_["tau1_eta"]                   = new binningOptionType("tau1_eta",                   50, -2.5,  +2.5);
  binningOptions_["tau1_phi"]                   = new binningOptionType("tau1_eta",                   50, -TMath::Pi(),  +TMath::Pi());
