  ...
  : HistManagerBase(cfg)
{
  ...
  binningOptions_["min_Deta_leadfwdJet_jet"]    = new binningOptionType("min_Deta_leadfwdJet_jet",   100,  0.,   10.);
  ...
  binningOptions_["lep1_eta"]                   = new binningOptionType("lep1_eta",                   50, 0.,  +2.5);
  binningOptions_["lep2_eta"]                   = new binningOptionType("lep2_eta",                   50, 0.,  +2.5);
  binningOptions_["eta_LepLep_los"]             = new binningOptionType("eta_LepLep_los",             50, 0.,  +3.5);
  binningOptions_["lep1_phi"]                   = new binningOptionType("lep1_phi",                   50, -TMath::Pi(),  +TMath::Pi());
  binningOptions_["lep2_phi"]                   = new binningOptionType("lep2_phi",                   50, -TMath::Pi(),  +TMath::Pi());
  ...
  binningOptions_["lep3_conePt"]                = new binningOptionType("lep3_conePt",                40,  0.,  150.);
  binningOptions_["lep4_conePt"]                = new binningOptionType("lep4_conePt",                40,  0.,  100.);
  ...
  binningOptions_["jet3_pt"]                    = new binningOptionType("jet3_pt",                    40,  0.,  150.);
  binningOptions_["jet4_pt"]                    = new binningOptionType("jet4_pt",                    40,  0.,  150.);
  binningOptions_["jet1_eta"]                   = new binningOptionType("jet1_eta",                   40, 0.,   +5.);
  binningOptions_["jet2_eta"]                   = new binningOptionType("jet2_eta",                   40, 0.,   +5.);
  binningOptions_["jet3_eta"]                   = new binningOptionType("jet3_eta",                   40, 0.,   +5.);
  binningOptions_["jet4_eta"]                   = new binningOptionType("jet4_eta",                   40, 0.,   +5.);
  binningOptions_["jet1_phi"]                   = new binningOptionType("jet1_phi",                   40, -TMath::Pi(),   +TMath::Pi());
  binningOptions_["jet2_phi"]                   = new binningOptionType("jet2_phi",                   40, -TMath::Pi(),   +TMath::Pi());
  binningOptions_["jet3_phi"]                   = new binningOptionType("jet3_phi",                   40, -TMath::Pi(),   +TMath::Pi());
  binningOptions_["jet4_phi"]                   = new binningOptionType("jet4_phi",                   40, -TMath::Pi(),   +TMath::Pi());
  ...
  binningOptions_["tau2_eta"]                   = new binningOptionType("tau2_eta",                   50, 0, +2.5);
  ...
  binningOptions_["met_LD"]                     = new binningOptionType("met_LD",                     40,  0.,  500.);
  ...
  binningOptions_["massL3"]                     = new binningOptionType("massL3",                     40,  0.,  500.);
  ...
  binningOptions_["res_HTT"]                    = new binningOptionType("res_HTT",                    50, 0.,   +1.);
  ...
  binningOptions_["tau1_eta"]                   = new binningOptionType("tau1_eta",                   50, 0.,  +2.5);
  binningOptions_["tau1_phi"]                   = new binningOptionType("tau1_phi",                   50, -TMath::Pi(),  +TMath::Pi());
