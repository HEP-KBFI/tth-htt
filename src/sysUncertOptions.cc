                        ...
                        bool isPt)
{
  ...
  branchNames_sys[kJetMET_jesAbsolute_EraDown]       = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesAbsolute_%s8Down", era_str.data());
  ...
  branchNames_sys[kJetMET_jesBBEC1_EraUp]            = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesBBEC1_%s8Up",   era_str.data());
  branchNames_sys[kJetMET_jesBBEC1_EraDown]          = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesBBEC1_%s8Down", era_str.data());
  ...
  branchNames_sys[kJetMET_jesEC2_EraUp]              = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesEC2_%s8Up",   era_str.data());
  branchNames_sys[kJetMET_jesEC2_EraDown]            = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesEC2_%s8Down", era_str.data());
  ...
  branchNames_sys[kJetMET_jesHF_EraUp]               = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesHF_%s8Up",   era_str.data());
  branchNames_sys[kJetMET_jesHF_EraDown]             = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesHF_%s8Down", era_str.data());
  ...
  branchNames_sys[kJetMET_jesRelativeSample_EraUp]   = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesRelativeSample_%s8Up",   era_str.data());
  branchNames_sys[kJetMET_jesRelativeSample_EraDown] = branchNames_sys[kJetMET_central_nonNominal] + Form("_jesRelativeSample_%s8Down", era_str.data());
  //
