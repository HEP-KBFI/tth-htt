...
void EvtHistManager_jetToTauFakeRate::fillHistograms(int numElectrons, int numMuons, int numHadTaus, int numJets, int numBJets_loose, int numBJets_medium,
						     double mLL, double mT_e, double mT_mu, double evtWeight)
{
