...
HISTOGRAM_COUNT_COMMON_MC = [
  histogram_name.replace(HISTOGRAM_COUNTWEIGHTED, HISTOGRAM_COUNTWEIGHTED_FULL) for histogram_name in HISTOGRAM_COUNT_COMMON_MC
]
...
HISTOGRAM_COUNT_EXTENDED_MC = [
  histogram_name.replace(HISTOGRAM_COUNTWEIGHTED, HISTOGRAM_COUNTWEIGHTED_FULL) for histogram_name in HISTOGRAM_COUNT_EXTENDED_MC
]
LHESCALEARR = [
  HISTOGRAM_COUNTWEIGHTED_LHESCALE,
  HISTOGRAM_COUNTWEIGHTED_LHESCALE_L1PREFIRE_NOM,
