...
//    and for e->tau and mu->tau misidentification rates
    ...
    const bool skipSRveto_1e = electronSelection != muonSelection && muonSelection     == kFakeable && countMuons(selLeptons)     == 0;
    const bool skipSRveto_1m = electronSelection != muonSelection && electronSelection == kFakeable && countElectrons(selLeptons) == 0;
