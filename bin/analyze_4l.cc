...
//--- fill histograms with events passing final selection
    ...
    if ( bdt_filler ) {
      ...
      bdt_filler -> operator()({ eventInfo.run, eventInfo.lumi, eventInfo.event })
          ...
          ("mT_lep4",             comp_MT_met(selLepton_fourth->cone_p4(), met.pt(), met.phi()))
          ...
          ("met_LD",              met_LD)
          ("massLT2",              comp_MT_met(selLeptons[0]->cone_p4() + selLeptons[1]->cone_p4(), met.pt(), met.phi()))
          ("massLT",              comp_MT_met(selLeptons[0]->cone_p4() + selLeptons[1]->cone_p4() + selLeptons[2]->cone_p4() + selLeptons[3]->cone_p4(), met.pt(), met.phi()))
    ...
    if(snm)
    {
      ...
      const double mT_lep4        = comp_MT_met(selLepton_fourth->cone_p4(), met.pt(), met.phi());
