...
//--- read python configuration parameters
  ...
  edm::ParameterSet cfg_addMEM = cfg.getParameter<edm::ParameterSet>("addMEM_3l_1tau");
  ...
  else throw cms::Exception("addMEM_3l_1tau") 
...
//--- declare missing transverse energy
  ...
  std::string branchName_memOutput = "memObjects_3l_1tau";
  MEMOutputWriter_3l_1tau* memWriter = new MEMOutputWriter_3l_1tau(Form("n%s", branchName_memOutput.data()), branchName_memOutput);
  memWriter->setBranches(outputTree);
  std::cout << "writing MEMOutput_3l_1tau objects to branch = '" << branchName_memOutput << "'" << std::endl;
...
//--- compute MEM values
    ...
    memWriter->write(memOutputs_3l_1tau);
