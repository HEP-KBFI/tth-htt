...
//    resolve overlaps in order of priority: muon, electron,
    ...
    if(isDEBUG)
    {
      for(std::size_t idxPreselHadTau = 0; idxPreselHadTau < selHadTaus.size(); ++idxPreselHadTau)
      {
...
//    as defined in Table 16 (10) of AN-2015/321 (AN-2016/211) for analysis of 2015 (2016) data
    ...
    const double mvaOutput_2lss_1tau_ttV = 0.;
    const double mvaOutput_2lss_1tau_ttbar = 0.;
...
//--- fill histograms with events passing final selection 
	...
	if ( isMC ) {
      ...
      selHistManager->evt_->fillHistograms(selElectrons.size(), selMuons.size(), selHadTaus.size(), 
        selJets.size(), selBJets_loose.size(), selBJets_medium.size(), 
        mvaOutput_2lss_ttV, mvaOutput_2lss_ttbar,
