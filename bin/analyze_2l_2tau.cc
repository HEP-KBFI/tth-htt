...
//--- declare histograms
  ...
  if ( selectBDT ) {
    ...
    bdt_filler -> register_variable<float_type>(
      ...
      "mindr_tau1_jet", "mindr_tau2_jet", "avg_dr_jet", "ptmiss",  "htmiss", "tau1_mva", "tau1_pt", "tau1_eta", "tau2_mva", "tau2_pt", "tau2_eta", "dr_taus", 
      "dr_leps", "mTauTauVis", "leptonPairCharge", "hadTauPairCharge", "lumiScale", "genWeight", "evtWeight",
