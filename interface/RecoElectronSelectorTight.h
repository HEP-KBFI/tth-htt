#ifndef tthAnalysis_HiggsToTauTau_RecoElectronSelectorTight_h
#define tthAnalysis_HiggsToTauTau_RecoElectronSelectorTight_h
...
#endif // tthAnalysis_HiggsToTauTau_RecoElectronSelectorTight_h
