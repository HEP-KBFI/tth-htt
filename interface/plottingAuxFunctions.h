...
{
  HistogramManager(const std::vector<std::string>& processesBackground, const std::string& processSignal, const std::vector<std::string>& categories, const edm::ParameterSet& cfg);
  ~HistogramManager();
