...
class RecoHadTauSelectorLoose
{
 public:
  ...
  friend class RecoHadTauCollectionSelectorLoose;
 protected: 
...
class RecoHadTauCollectionSelectorLoose
{
 public:
  RecoHadTauCollectionSelectorLoose(int index = -1, bool debug = false)
    : selIndex_(index)
 ...
 protected: 
  int selIndex_;
  RecoHadTauSelectorLoose selector_;
};
