#ifndef tthAnalysis_HiggsToTauTau_SyncNtupleManager_h
#define tthAnalysis_HiggsToTauTau_SyncNtupleManager_h
...
#endif // tthAnalysis_HiggsToTauTau_SyncNtupleManager_h
