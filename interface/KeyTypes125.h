...
#define RUN_TYPE               Int_t
#define LUMI_TYPE              Int_t
#define EVT_TYPE               Int_t

#define NLEPTONS_TYPE          Int_t
#define LEPT_PT_TYPE           Double_t
#define LEPT_ETA_TYPE          Double_t
#define LEPT_PHI_TYPE          Double_t
#define LEPT_MASS_TYPE         Double_t
#define LEPT_DXY_TYPE          Double_t
#define LEPT_DZ_TYPE           Double_t
...
#define MET_PT_TYPE            Double_t
#define MET_ETA_TYPE           Double_t
#define MET_PHI_TYPE           Double_t
#define MET_MASS_TYPE          Double_t
...
#define GEN_ETA_TYPE           Double_t
#define GEN_PHI_TYPE           Double_t
#define GEN_MASS_TYPE          Double_t
#define GEN_PDG_ID_TYPE        Int_t

#define GEN_NJETS_TYPE         Int_t
#define GEN_JET_PT_TYPE        Double_t
#define GEN_JET_ETA_TYPE       Double_t
#define GEN_JET_PHI_TYPE       Double_t
#define GEN_JET_MASS_TYPE      Double_t

#define GEN_NTAUS_TYPE         Int_t
#define GEN_TAU_PT_TYPE        Double_t
#define GEN_TAU_ETA_TYPE       Double_t
#define GEN_TAU_PHI_TYPE       Double_t
#define GEN_TAU_MASS_TYPE      Double_t
