...
double sf_eToTauFakeRate_2016(double hadTau_pt, double hadTau_absEta, int hadTauSelection_antiElectron, int central_or_shift = kFRet_central);
enum { kFRmt_central, kFRmt_shiftUp, kFRmt_shiftDown };
double sf_muToTauFakeRate_2016(double hadTau_pt, double hadTau_absEta, int hadTauSelection_antiMuon, int central_or_shift = kFRet_central);
