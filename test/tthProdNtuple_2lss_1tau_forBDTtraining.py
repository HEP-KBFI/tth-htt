...
version = "2017Jan12_forBDTtraining" # must be the same version as in test/tthAnalyzeRun_2lss_1tau.py !
...
if __name__ == '__main__':
  ...
  ntupleProduction = prodNtupleConfig_2lss_1tau(
    ...
    cfgFile_prodNtuple = "produceNtuple_2lss_1tau_forBDTtraining_cfg.py",
    samples = samples,
    era = ERA,
    debug = False,
