...
cp /home/veelken/ttHAnalysis/${VERSION}_dR03mvaLoose/datacards/prepareDatacards_1l_2tau_mvaOutput_1l_2tau_ttbar.root /home/veelken/public/HIG15008_datacards/Tallinn/cut_optimization/1l_2tau/ttH_1l_2tau_${VERSION}_dR03mvaLoose_mvaOutput_1l_2tau_ttbar.input.root
...
cp /home/veelken/ttHAnalysis/${VERSION}_dR03mvaMedium/datacards/prepareDatacards_1l_2tau_mvaOutput_1l_2tau_ttbar.root /home/veelken/public/HIG15008_datacards/Tallinn/cut_optimization/1l_2tau/ttH_1l_2tau_${VERSION}_dR03mvaMedium_mvaOutput_1l_2tau_ttbar.input.root
...
cp /home/veelken/ttHAnalysis/${VERSION}_dR03mvaTight/datacards/prepareDatacards_1l_2tau_mvaOutput_1l_2tau_ttbar.root /home/veelken/public/HIG15008_datacards/Tallinn/cut_optimization/1l_2tau/ttH_1l_2tau_${VERSION}_dR03mvaTight_mvaOutput_1l_2tau_ttbar.input.root
...
cp /home/veelken/ttHAnalysis/${VERSION}_dR03mvaVTight/datacards/prepareDatacards_1l_2tau_mvaOutput_1l_2tau_ttbar.root /home/veelken/public/HIG15008_datacards/Tallinn/cut_optimization/1l_2tau/ttH_1l_2tau_${VERSION}_dR03mvaVTight_mvaOutput_1l_2tau_ttbar.input.root
...
cp /home/veelken/ttHAnalysis/${VERSION}_dR03mvaVVTight/datacards/prepareDatacards_1l_2tau_mvaOutput_1l_2tau_ttbar.root /home/veelken/public/HIG15008_datacards/Tallinn/cut_optimization/1l_2tau/ttH_1l_2tau_${VERSION}_dR03mvaVVTight_mvaOutput_1l_2tau_ttbar.input.root
