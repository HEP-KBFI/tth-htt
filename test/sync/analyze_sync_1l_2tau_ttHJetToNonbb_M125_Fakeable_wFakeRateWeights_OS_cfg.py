...
process.analyze_1l_2tau = cms.PSet(
    ...
    selEventsFileName_output = cms.string('output/selEvents_ttHJetToNonbb_1l_2tau_M125_Fakeable_wFakeRateWeights_OS.txt')
)

process.fwliteInput.fileNames = cms.vstring(['/home/andres/tth/sync/ttHJetToNonbb_M125_13TeV_sync_summer_v0.root'])
process.fwliteOutput.fileName = cms.string('output/ttHJetToNonbb_1l_2tau_M125_Fakeable_wFakeRateWeights_OS.root')
process.analyze_1l_2tau.process = cms.string('signal')
process.analyze_1l_2tau.histogramDir = cms.string('1l_2tau_OS_Fakeable_wFakeRateWeights')
...
process.analyze_1l_2tau.leptonSelection = cms.string('Fakeable')
process.analyze_1l_2tau.apply_leptonGenMatching = cms.bool(True)
process.analyze_1l_2tau.hadTauSelection = cms.string('Fakeable|dR03mvaTight')
process.analyze_1l_2tau.hadTauChargeSelection = cms.string('OS')
process.analyze_1l_2tau.apply_hadTauGenMatching = cms.bool(True)
process.analyze_1l_2tau.applyFakeRateWeights = cms.string('3L')
process.analyze_1l_2tau.hadTauFakeRateWeight.inputFileName = cms.string('tthAnalysis/HiggsToTauTau/data/FR_tau_2016.root')
process.analyze_1l_2tau.hadTauFakeRateWeight.lead.fitFunctionName = cms.string('jetToTauFakeRate/dR03mvaMedium/$etaBin/fitFunction_data_div_mc_hadTaus_pt')
process.analyze_1l_2tau.hadTauFakeRateWeight.sublead.fitFunctionName = cms.string('jetToTauFakeRate/dR03mvaMedium/$etaBin/fitFunction_data_div_mc_hadTaus_pt')
...
#process.analyze_1l_2tau.selEventsFileName_output = cms.string('/home/veelken/ttHAnalysis/2016/2016Oct31/output_rle/1l_2tau/Fakeable_wFakeRateWeights_OS/ttHJetToNonbb_M125/rle_1l_2tau_ttHJetToNonbb_M125_Fakeable_wFakeRateWeights_OS_central_0.txt')
