...
process.analyze_2lss_1tau = cms.PSet(
    ...
    selEventsFileName_output = cms.string('output/selEvents_ttHJetToNonbb_2lss_1tau_M125_Tight_OS.txt')
)

process.fwliteInput.fileNames = cms.vstring(['/home/andres/tth/sync/ttHJetToNonbb_M125_13TeV_sync_summer_v0.root'])
process.fwliteOutput.fileName = cms.string('output/ttHJetToNonbb_2lss_1tau_M125_Tight_OS.root')
process.analyze_2lss_1tau.process = cms.string('signal')
process.analyze_2lss_1tau.histogramDir = cms.string('2lss_1tau_OS_Tight')
...
#process.analyze_2lss_1tau.selEventsFileName_output = cms.string('/home/veelken/ttHAnalysis/2016/2016Nov03/output_rle/2lss_1tau/Tight_OS/ttHJetToNonbb_M125/rle_2lss_1tau_ttHJetToNonbb_M125_Tight_OS_central_0.txt')
