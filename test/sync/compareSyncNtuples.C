		    ...
		    const std::string& outputFilePath, const std::string& outputFileName)
{
  ...
  if ( yMax > 0. ) {
    ...
    double yMax_hist = histogram_ref->GetMaximum();
    if ( histogram2 ) yMax_hist = TMath::Max(yMax_hist, histogram2->GetMaximum());
    if ( histogram3 ) yMax_hist = TMath::Max(yMax_hist, histogram3->GetMaximum());
    if ( histogram4 ) yMax_hist = TMath::Max(yMax_hist, histogram4->GetMaximum());
    if ( histogram5 ) yMax_hist = TMath::Max(yMax_hist, histogram5->GetMaximum());
    if ( histogram6 ) yMax_hist = TMath::Max(yMax_hist, histogram6->GetMaximum());
    histogram_ref->SetMaximum(30.*yMax_hist);
  }
...
void compareSyncNtuples()
{
  ...
  samples.push_back("ttHJetToTT_M125_13TeV_amcatnloFXFX_madspin_pythia8");
  //samples.push_back("TT_TuneCUETP8M1_13TeV-powheg-pythia8");

  std::string inputFilePath_ref = "/home/andres/tth/VHbbNtuples_8_0_x/CMSSW_8_0_19/src/tthAnalysis/HiggsToTauTau/test/sync/sync_ntuples_presel/";
  std::map<std::string, std::string> inputFileNames_ref; // key = sample
  inputFileNames_ref["ttHJetToTT_M125_13TeV_amcatnloFXFX_madspin_pythia8"] = "sync_ntuple_summer_v1.root";
  inputFileNames_ref["TT_TuneCUETP8M1_13TeV-powheg-pythia8"] = "ttJet_13TeV_ntuples_sync.root";
  ...
  std::string inputFilePath_test = "/home/andres/tth/VHbbNtuples_8_0_x/CMSSW_8_0_19/src/tthAnalysis/HiggsToTauTau/test/sync/sync_ntuples_presel/";
  std::map<std::string, std::string> inputFileNames_test; // key = sample
  inputFileNames_test["ttHJetToTT_M125_13TeV_amcatnloFXFX_madspin_pythia8"] = "syncNtuple_ttH_80X_Summer16.root";
  inputFileNames_test["TT_TuneCUETP8M1_13TeV-powheg-pythia8"] = "syncNtuple_ttjets.root";
  std::string treeName_test = "syncTree";
  std::string legendEntry_test = "LLR";
  std::string selection_test = "";

  //std::string inputFilePath_test = "/afs/cern.ch/work/t/tstreble/public/syncNtuple_ttH_Htautau/";
  std::string inputFilePath_test2 = "/home/andres/tth/VHbbNtuples_8_0_x/CMSSW_8_0_19/src/tthAnalysis/HiggsToTauTau/test/sync/sync_ntuples_presel/";
  std::map<std::string, std::string> inputFileNames_test2; // key = sample
  inputFileNames_test2["ttHJetToTT_M125_13TeV_amcatnloFXFX_madspin_pythia8"] = "syncNtuple.root";
  inputFileNames_test2["TT_TuneCUETP8M1_13TeV-powheg-pythia8"] = "ttJetsNtuple.root";
  std::string treeName_test2 = "syncTree";
  std::string legendEntry_test2 = "Cornell";
  std::string selection_test2 = "";

  //std::string inputFilePath_test3 = "/afs/cern.ch/user/m/matze/public/ttH/";
  std::string inputFilePath_test3 = "/home/andres/tth/VHbbNtuples_8_0_x/CMSSW_8_0_19/src/tthAnalysis/HiggsToTauTau/test/sync/sync_ntuples_presel/";
  std::map<std::string, std::string> inputFileNames_test3; // key = sample
  inputFileNames_test3["ttHJetToTT_M125_13TeV_amcatnloFXFX_madspin_pythia8"] = "sync_ntuple_m17.root";
  std::string treeName_test3 = "syncTree";
  std::string legendEntry_test3 = "Notre Dame";
  std::string selection_test3 = "";

  std::string outputFilePath = "sync_plots_general";

  std::vector<branchEntryType*> branchesToCompare;
  branchesToCompare.push_back(new branchEntryType("n_presel_mu", "I", "", 20, -0.5, 8.5));
  branchesToCompare.push_back(new branchEntryType("n_presel_ele", "I", "", 20, -0.5, 8.5));
  branchesToCompare.push_back(new branchEntryType("n_presel_tau", "I", "", 20, -0.5, 12.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu0_miniIsoNeutral", "F", "n_presel_mu >= 1", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("mu0_miniIsoCharged", "F", "n_presel_mu >= 1", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("mu0_E", "F", "n_presel_mu >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mu0_jetPtRatio", "F", "n_presel_mu >= 1", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("mu0_leptonMVA", "F", "n_presel_mu >= 1", 100, -1.1, +1.1));
  branchesToCompare.push_back(new branchEntryType("mu0_jetCSV", "F", "n_presel_mu >= 1", 100, -0.01, +1.01));
  branchesToCompare.push_back(new branchEntryType("mu0_segmentCompatibility", "F", "n_presel_mu >= 1", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("mu0_miniRelIso", "F", "n_presel_mu >= 1", 100, -0.01, 0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu0_dz", "F", "n_presel_mu >= 1", 100, -0.5, +0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_miniIsoNeutral", "F", "n_presel_mu >= 2", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("mu1_miniIsoCharged", "F", "n_presel_mu >= 2", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("mu1_E", "F", "n_presel_mu >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mu1_jetPtRatio", "F", "n_presel_mu >= 2", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("mu1_leptonMVA", "F", "n_presel_mu >= 2", 100, -1.1, +1.1));
  branchesToCompare.push_back(new branchEntryType("mu1_jetCSV", "F", "n_presel_mu >= 2", 100, -0.01, +1.01));
  branchesToCompare.push_back(new branchEntryType("mu1_segmentCompatibility", "F", "n_presel_mu >= 2", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_miniRelIso", "F", "n_presel_mu >= 2", 100, -0.01, 0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_dz", "F", "n_presel_mu >= 2", 100, -0.5, +0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("ele0_miniIsoNeutral", "F", "n_presel_ele >= 1", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("ele0_miniIsoCharged", "F", "n_presel_ele >= 1", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("ele0_E", "F", "n_presel_ele >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ele0_jetPtRatio", "F", "n_presel_ele >= 1", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("ele0_leptonMVA", "F", "n_presel_ele >= 1", 100, -1.1, +1.1));
  branchesToCompare.push_back(new branchEntryType("ele0_jetCSV", "F", "n_presel_ele >= 1", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("ele0_miniRelIso", "F", "n_presel_ele >= 1", 100, -0.01, 0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("ele0_dz", "F", "n_presel_ele >= 1", 100, -0.5, +0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_miniIsoNeutral", "F", "n_presel_ele >= 2", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("ele1_miniIsoCharged", "F", "n_presel_ele >= 2", 100, -0.01, 25.));
  branchesToCompare.push_back(new branchEntryType("ele1_E", "F", "n_presel_ele >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ele1_jetPtRatio", "F", "n_presel_ele >= 2", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("ele1_leptonMVA", "F", "n_presel_ele >= 2", 100, -1.1, +1.1));
  branchesToCompare.push_back(new branchEntryType("ele1_jetCSV", "F", "n_presel_ele >= 2", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_miniRelIso", "F", "n_presel_ele >= 2", 100, -0.01, 0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_dz", "F", "n_presel_ele >= 2", 100, -0.5, +0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("tau0_byCombinedIsolationDeltaBetaCorr3Hits", "F", "n_presel_tau >= 1", 100, -0.01, 10.));
  ...
  branchesToCompare.push_back(new branchEntryType("tau1_byCombinedIsolationDeltaBetaCorr3Hits", "F", "n_presel_tau >= 2", 100, -0.01, 10.));
  ...
  branchesToCompare.push_back(new branchEntryType("jet0_CSV", "F", "n_presel_jet >= 1", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("jet1_CSV", "F", "n_presel_jet >= 2", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("jet2_CSV", "F", "n_presel_jet >= 3", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("jet3_CSV", "F", "n_presel_jet >= 4", 100, -0.01, +1.01));
  ...
  branchesToCompare.push_back(new branchEntryType("MHT", "F", "", 100, 0., 500.));
  branchesToCompare.push_back(new branchEntryType("metLD", "F", "", 36, 0, +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("isGenMatched", "I", "", 22, -0.5, 1.5));
  branchesToCompare.push_back(new branchEntryType("lep0_conept", "F", "", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("lep1_conept", "F", "", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mindr_lep0_jet", "F", "", 100, 0.4, 3.));
  branchesToCompare.push_back(new branchEntryType("mindr_lep1_jet", "F", "", 100, 0.4, 3.));
  branchesToCompare.push_back(new branchEntryType("MT_met_lep0", "F", "", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("avg_dr_jet", "F", "", 100, 0., 2*TMath::Pi()));
  ...
  branchesToCompare.push_back(new branchEntryType("FR_weight", "F", "", 100, 0., 1.2));
  branchesToCompare.push_back(new branchEntryType("triggerSF_weight", "F", "", 100, 0.6, 1.4));
  branchesToCompare.push_back(new branchEntryType("leptonSF_weight", "F", "", 100, 0.6, 1.4));
  branchesToCompare.push_back(new branchEntryType("tauSF_weight", "F", "", 100, 0.8, 1.2));
  branchesToCompare.push_back(new branchEntryType("bTagSF_weight", "F", "", 100, 0., 3.));
  branchesToCompare.push_back(new branchEntryType("PU_weight", "F", "", 100, 0., 2.));
  branchesToCompare.push_back(new branchEntryType("MC_weight", "F", "", 100, -2., 2.));
  ...
  for ( std::vector<std::string>::const_iterator sample = samples.begin();
    ...
    TFile* inputFile_ref = 0;
    TTree* tree_ref = 0;
    if ( inputFileNames_ref.find(*sample) != inputFileNames_ref.end() ) {
      inputFile_ref = openFile(inputFilePath_ref, inputFileNames_ref[*sample]);
      tree_ref = loadTree(inputFile_ref, treeName_ref);
    }

    TFile* inputFile_test = 0;
    TTree* tree_test = 0;
    if ( inputFileNames_test.find(*sample) != inputFileNames_test.end() ) {
      inputFile_test = openFile(inputFilePath_test, inputFileNames_test[*sample]);
      tree_test = loadTree(inputFile_test, treeName_test);
    }

    TFile* inputFile_test2 = 0;
    TTree* tree_test2 = 0;
    if ( inputFileNames_test2.find(*sample) != inputFileNames_test2.end() ) {
      inputFile_test2 = openFile(inputFilePath_test2, inputFileNames_test2[*sample]);
      tree_test2 = loadTree(inputFile_test2, treeName_test2);
    }

    TFile* inputFile_test3 = 0;
    TTree* tree_test3 = 0;
    if ( inputFileNames_test3.find(*sample) != inputFileNames_test3.end() ) {
      inputFile_test3 = openFile(inputFilePath_test3, inputFileNames_test3[*sample]);
      tree_test3 = loadTree(inputFile_test3, treeName_test3);
    }

    std::string outputFilePath_sample = Form("%s/%s", outputFilePath.data(), sample->data());

    for ( std::vector<branchEntryType*>::const_iterator branch = branchesToCompare.begin();
	  branch != branchesToCompare.end(); ++branch ) {
      std::cout << "plotting " << (*branch)->branchName_ << " for sample = " << (*sample) << "..." << std::endl;
      
      branchEntryType* branch_ref = 0;
      TH1* histogram_ref = 0;
      if ( tree_ref ) {
	std::cout << " ...for Ntuple of " << legendEntry_ref << " group" << std::endl;
	branch_ref = (*branch)->Clone(Form("ref_%s", sample->data()));
	branch_ref->fillHistogram(tree_ref, selection_ref);
	normalizeHistogram(branch_ref->histogram_);
	histogram_ref = branch_ref->histogram_;
      }
      
      branchEntryType* branch_test = 0;
      TH1* histogram_test = 0;
      if ( tree_test ) {
	std::cout << " ...for Ntuple of " << legendEntry_test << " group" << std::endl;
        branch_test = (*branch)->Clone(Form("test_%s", sample->data()));
	branch_test->fillHistogram(tree_test, selection_test);
	normalizeHistogram(branch_test->histogram_);
	histogram_test = branch_test->histogram_;
      }
      
      branchEntryType* branch_test2 = 0;
      TH1* histogram_test2 = 0;
      if ( tree_test2 ) {
	std::cout << " ...for Ntuple of " << legendEntry_test2 << " group" << std::endl;
	branch_test2 = (*branch)->Clone(Form("test2_%s", sample->data()));
	branch_test2->fillHistogram(tree_test2, selection_test2);
	normalizeHistogram(branch_test2->histogram_);
	histogram_test2 = branch_test2->histogram_;
      }
      
      branchEntryType* branch_test3 = 0;
      TH1* histogram_test3 = 0;
      if ( tree_test3 ) {
	std::cout << " ...for Ntuple of " << legendEntry_test3 << " group" << std::endl;
	branch_test3 = (*branch)->Clone(Form("test3_%s", sample->data()));
	branch_test3->fillHistogram(tree_test3, selection_test3);
	normalizeHistogram(branch_test3->histogram_);
	histogram_test3 = branch_test3->histogram_;
      }
      
      std::string outputFileName = Form("compareSyncNtuples_%s.png", (*branch)->branchName_.data());
      showHistograms(800, 900, 
		     histogram_ref, legendEntry_ref, 
		     histogram_test, legendEntry_test, 
		     histogram_test2, legendEntry_test2, 
		     histogram_test3, legendEntry_test3, 
		     //NULL, "", 
		     NULL, "", 
		     NULL, "", 
		     ...
		     true, 1.e-4, -1., "N", 1.30,
		     0.16, 0.80,
		     outputFilePath_sample, outputFileName);
