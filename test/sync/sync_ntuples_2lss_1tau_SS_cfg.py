...
process.syncNtuple.hadTauFakeRateWeight.applyGraph_sublead = cms.bool(False)
process.syncNtuple.hadTauFakeRateWeight.applyFitFunction_sublead = cms.bool(True)
