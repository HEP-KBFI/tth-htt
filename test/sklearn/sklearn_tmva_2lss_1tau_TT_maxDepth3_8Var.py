...
sklearn_to_tmva.gbr_to_tmva(
    cls,
    data[trainVars()],
    "TMVABDT_2lss_1tau_maxDepth3_8Var_frWt_wMEMall.xml",
    coef=2
)
...
fout = TFile("2lss_1tau_performance_maxDepth3_8Var_frWt_wMEMall.root", "RECREATE")
c1 = TCanvas()
c1.SetFillColor(10)
c1.SetBorderSize(2)
...
c1.SaveAs("roc_overtraining_2lss_1tau_maxDepth3_8Var_frWt_wMEMall.pdf")
fout.Write()
fout.Close()
