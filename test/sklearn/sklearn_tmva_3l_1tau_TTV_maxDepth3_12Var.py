...
data_ttw = pandas.read_csv("3l_1tau_TTW_30Mar2017.csv")
data_ttz = pandas.read_csv("3l_1tau_TTZ_30Mar2017.csv")
...
sklearn_to_tmva.gbr_to_tmva(
    cls,
    data[trainVars()],
    "TMVABDT_3l_1tau_ttV_maxDepth3_12Var_frWt.xml",
    coef=2
)
...
fout = TFile("3l_1tau_ttV_performance_maxDepth3_12Var_frWt.root", "RECREATE")
c1 = TCanvas()
c1.SetFillColor(10)
c1.SetBorderSize(2)
...
c1.SaveAs("roc_overtraining_3l_1tau_ttV_maxDepth3_12Var_frWt.pdf")
fout.Write()
fout.Close()
...
filename = 'sklearn_3l_1tau_ttV_maxDepth3_12Var_frWt.pkl'
