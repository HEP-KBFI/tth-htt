...
process.fwliteInput.fileNames = cms.vstring(
    '/home/arun/ttHAnalysis/2016Aug01_dR03mvaVLoose/histograms/histograms_harvested_stage1_0l_2tau.root'
)
...
process.trainTTHMVA_1l_2tau = cms.PSet(
    ...
    outputFileName = cms.string('/scratch/arun/mvaTraining/2016Aug01_dR03mvaVLoose/trainTTHMVA_0l_2tau_woTauID_woNJet.root')
)
