  ...
  for idx_job_resubmission in range(max_job_resubmission):
    ...
    analysis = analyzeConfig_3l_1tau(
      ...
      histograms_to_fit                     = {
        ...
        "mvaDiscr_3l"              : {},
        "mTauTauVis"               : {},
        "mvaOutput_plainKin_tt"    : { 'quantile_rebin' : 6 }, # BDT2; quantile in all bkg
        "mvaOutput_plainKin_ttV"   : { 'quantile_rebin' : 6 }, # BDT1; quantile in all bkg
        "mvaOutput_plainKin_SUM_M" : { 'quantile_rebin' : 6 }, # BDT3; quantile in all bkg
