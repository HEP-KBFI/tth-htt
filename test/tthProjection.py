...
projections = [ 'pileup', 'btagSF', 'btagSFSL', 'count', 'subjetCount' ]
...
elif projection in [ 'btagSF', 'btagSFSL', 'count', 'subjetCount' ]:
  if projection == 'btagSF':
    projection_module = "btagSFRatio"
  elif projection == 'btagSFSL':
    projection_module = "btagSFRatioSL"
